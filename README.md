# Test task in Wht.Agency

Cloning repository:
```
git clone git@github.com:Kozatskiy-Artem/test-task-wht.agency.git
```
Or
```
git clone https://github.com/Kozatskiy-Artem/test-task-wht.agency.git
```
